...
-- ENTRADAS
INSERT INTO entrada(descricao, data, valor, caixa_id) values ('Venda da banda', now(), 50, 2)
INSERT INTO entrada(descricao, data, valor, caixa_id) values ('Venda da banda', now(), 150, 2)
INSERT INTO entrada(descricao, data, valor, caixa_id) values ('Venda da movidade', now(), 100, 1)
INSERT INTO entrada(descricao, data, valor, caixa_id) values ('Contribuição em éspecie', now(), 200, 1)
